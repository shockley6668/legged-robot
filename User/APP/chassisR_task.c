...
void ChassisR_task(void) {
  ...
  dm6006_fbdata_init(&chassis_move.joint_motor[5]);
  dm8006_fbdata_init(&chassis_move.joint_motor[6]);
  dm8006_fbdata_init(&chassis_move.joint_motor[7]);
  dm8006_fbdata_init(&chassis_move.joint_motor[8]);
  dm6006_fbdata_init(&chassis_move.joint_motor[9]);
