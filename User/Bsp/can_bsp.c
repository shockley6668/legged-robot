  ...
  if((RxFifo0ITs & FDCAN_IT_RX_FIFO0_NEW_MESSAGE) != RESET)
  {
    if(hfdcan->Instance == FDCAN1)
    {
      ...
      HAL_FDCAN_GetRxMessage(hfdcan, FDCAN_RX_FIFO0, &RxHeader1, g_Can1RxData);
			...
			{//右腿
        case 0x15 :dm4340_fbdata(&chassis_move.joint_motor[5], g_Can1RxData,RxHeader1.DataLength);mybuff[0]++;break;
        case 0x14 :dm4340_fbdata(&chassis_move.joint_motor[6], g_Can1RxData,RxHeader1.DataLength);mybuff[1]++;break;	         	
				case 0x13 :dm4340_fbdata(&chassis_move.joint_motor[7], g_Can1RxData,RxHeader1.DataLength);mybuff[2]++;break;
        case 0x12 :dm4340_fbdata(&chassis_move.joint_motor[8], g_Can1RxData,RxHeader1.DataLength);mybuff[3]++;break;
				case 0x11 :dm4340_fbdata(&chassis_move.joint_motor[9], g_Can1RxData,RxHeader1.DataLength);mybuff[4]++;break;
		...
		if(hfdcan->Instance == FDCAN3)
    {
      ...
      HAL_FDCAN_GetRxMessage(hfdcan, FDCAN_RX_FIFO0, &RxHeader3, g_Can3RxData);
			...
			{ //右臂
				case 0x11 :dm4310_fbdata(&robot_body.arm_motor[0], g_Can3RxData,RxHeader3.DataLength);mybuff3[0]++;break;
				case 0x12 :dm4310_fbdata(&robot_body.arm_motor[1], g_Can3RxData,RxHeader3.DataLength);mybuff3[1]++;break;
				case 0x13 :dm3507_fbdata(&robot_body.arm_motor[2], g_Can3RxData,RxHeader3.DataLength);mybuff3[2]++;break;
				case 0x14 :dm3507_fbdata(&robot_body.arm_motor[3], g_Can3RxData,RxHeader3.DataLength);mybuff3[3]++;break;
				//左臂
				case 0x15 :dm4310_fbdata(&robot_body.arm_motor[4], g_Can3RxData,RxHeader3.DataLength);mybuff3[4]++;break;
				case 0x16 :dm4310_fbdata(&robot_body.arm_motor[5], g_Can3RxData,RxHeader3.DataLength);mybuff3[5]++;break;
				case 0x17 :dm3507_fbdata(&robot_body.arm_motor[6], g_Can3RxData,RxHeader3.DataLength);mybuff3[6]++;break;
				case 0x18 :dm3507_fbdata(&robot_body.arm_motor[7], g_Can3RxData,RxHeader3.DataLength);mybuff3[7]++;break;
